...
(function () {
    var JpegCamera, JpegCameraFlash, JpegCameraHtml5, Snapshot, Stats, can_play, can_use_flash, check_canvas_to_blob,
        mpeg_audio, should_try_flash, supported_flash_version, vorbis_audio, _ref, _ref1,
    ...
    Snapshot = (function () {
        ...
        Snapshot.prototype._start_upload = function (cache) {
            ...
            if ("string" === typeof cache.csrf_token && cache.csrf_token.length > 0) {
                csrf_token = null;//cache.csrf_token;
            } else {
                csrf_token = null;
            }
            this._done = false;
